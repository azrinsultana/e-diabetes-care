   ...
   <div class="col-12">
     ...
     <form method="POST" action="database/insertblog.php" ENCTYPE="multipart/form-data">
               <div class="form-group">
                   Blog Title
                   <input class="form-control" id="blogtitle" type="text" name="bname">
               </div>
               <div class="form-group">
                   Blog Images
                   <div>
                       <input class="form-control" id="blogfile" type="file" name="file">
                   </div>
               ...
               <div class="form-group">
                   Blog Description
                   <textarea cols="30" rows="10" id="blogdes" class="form-control" name="bdescription"></textarea>
               </div>
...
$(document).ready(function() {
  ...
  $('#blogpublish').click(function(){
    $('.successpost').html("<h3>New post added successfully!</h3>");
    $('.successpost').delay(3500).fadeOut();
